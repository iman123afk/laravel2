...
import ReactQuill from 'react-quill'; // Gunakan ReactQuill untuk WYSIWYG
import 'react-quill/dist/quill.snow.css'; // Tambahkan gaya Quill
...
export default function Chirp({ chirp }) {
    ...
    const { data, setData, patch, clearErrors, reset, errors } = useForm({
        message: chirp.message, // Data WYSIWYG disimpan sebagai HTML
    });
            ...
            <div className="flex-1">
                ...
                {editing ? (
                    <form onSubmit={submit}>
                        {/* Gunakan ReactQuill untuk editing */}
                        <ReactQuill
                            theme="snow"
                            value={data.message}
                    ...
                    dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(chirp.message) }} />
                )}
            </div>
        </div>
    );
